...
const Hero = () => {
  return (
    <section className="max-container grid max-xl:grid-cols-1 grid-cols-2 gap-16">
      ...
      <div className="flex flex-col max-lg:items-center max-lg:text-center my-auto">
        ...
        <p className="info-text text-base max-lg:text-md font-light mt-8 w-[80%]">I am an Information Technology graduate from the Philippines—eager to build simple to complex web development projects. Ever since freshman year in college, I have found myself becoming passionate about the wonders of front-end development and UI/UX Design. </p>
        <p className="info-text text-base max-lg:text-md font-light mt-8 w-[80%]">I believe that <span className="font-medium">adding functionality to aesthetics</span> significantly <span className="font-medium">boosts the credibility and engagement</span> of websites and web applications.</p>
      ...
      <div className="flex justify-center">
        <img 
          ...
          className="/*w-[90%]*/ /*w-full max-lg:w-[80%]*/ w-[90%] max-lg:w-[75%] object-contain"
        />
      </div>
    </section>
  )
